...
import { Service } from "../../modules_from_other_services/domain/entities/service";
import { ServiceAggregate } from "../../modules_from_other_services/domain/aggregates/serviceAggregate";
import { ServiceDetails } from "../../modules_from_other_services/domain/value-objects/serviceDetails";
import { ServiceModel } from "./persistence/model/serviceModel";
import { redis, connectRedis } from "@fixserv-colauncha/shared";
import { SkillSet } from "../../modules_from_other_services/domain/value-objects/skillSet";
...
export class ServiceRepositoryImpl implements IServiceRepository {
  ...
  async findWithQuery(query: any): Promise<Service[]> {
